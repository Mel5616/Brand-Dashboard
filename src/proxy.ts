...
const PUBLIC = ["/login", "/auth", "/log-gift", "/request", "/p", "/c", "/s", "/deals", "/w", "/brief", "/nanit", "/sign", "/deck", "/g", "/agreement", "/api/signout"];
...
const PUBLIC_API = ["/api/influencer/products", "/api/influencer/roster", "/api/influencer/entries", "/api/influencer/invoice", "/api/influencer/avatar", "/api/nanit/public", "/api/releases/sign", "/api/decks/track", "/api/decks/og", "/api/public-sales-request", "/api/sales-requests/upload", "/api/influencer-agreements/sign"];
