  ...
  <tr><td align="center">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:14px;border:1px solid #e5e9f0;overflow:hidden;font-family:Arial,Helvetica,sans-serif;">
      ...
      <tr><td style="padding:28px 32px 8px;text-align:center;">
        <p style="margin:0 0 10px;font:bold 26px Arial,Helvetica,sans-serif;color:#0f172a;letter-spacing:-0.01em;">Last call on your cart</p>
        <p style="margin:0 auto;max-width:420px;font:14px/1.6 Arial,Helvetica,sans-serif;color:#64748b;">Here's ${fmtFull(offer.discountAmount)} off to make this yours.</p>
      </td></tr>
      ...
      <tr><td style="padding:24px 32px;text-align:center;">
        ...
        <p style="margin:14px 0 0;font:12.5px Arial,Helvetica,sans-serif;color:#94a3b8;">${fmtFull(offer.discountAmount)} off orders over ${fmtFull(offer.minSpend)} · expires {{ person.winback_expires }} · one-time use</p>
      </td></tr>
      ...
      <tr><td style="padding:24px 32px 32px;border-top:1px solid #eef1f5;text-align:center;">
        ...
        <p style="margin:0 0 14px;font:11.5px Arial,Helvetica,sans-serif;color:#94a3b8;"><a href="mailto:hello@coolkidz.com.au" style="color:#94a3b8;text-decoration:underline;">hello@coolkidz.com.au</a></p>
