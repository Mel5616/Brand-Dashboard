...
const TAB_GROUPS: { label: string; ids: TabId[] }[] = [
  ...
  { label: "Owned & Earned", ids: ["email", "seo", "social", "youtube", "influencer", "gifting", "influencer-agreements", "nanit", "releases", "affiliates", "pa-budget", "pa-tracker", "pa-revenue", "documents"] },
