...
const TAB_GROUPS: { label: string; ids: TabId[] }[] = [
  ...
  { label: "Retailer Hub", ids: ["brand-packs", "price-lists", "hub-fact-sheets", "brand-overview", "stock-availability", "order-forms", "customers", "customer-forms", "terms"] },
