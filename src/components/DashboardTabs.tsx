...
const TAB_GROUPS: { label: string; ids: TabId[] }[] = [
  ...
  { label: "Plan", ids: ["campaign-calendar", "promotions", "discount-codes", "reviews", "calendar", "content", "events", "show-deals", "activations", "timeline"] },
