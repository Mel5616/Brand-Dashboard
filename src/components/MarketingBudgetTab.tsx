    ...
    <div id="budget-report" className="max-w-screen-2xl mx-auto px-6 py-8 space-y-6">
      ...
      <div className="flex items-center gap-2 flex-wrap no-print">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {canEdit && <button onClick={() => window.print()} className="inline-flex items-center gap-1.5 text-sm font-medium text-white bg-slate-800 hover:bg-slate-900 rounded-lg px-3.5 py-1.5 transition shadow-sm">
