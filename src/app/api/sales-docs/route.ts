...
const CATEGORIES = ["price_list", "brand_overview", "terms"] as const;
type Category = (typeof CATEGORIES)[number];
const CAT_TAB: Record<Category, string> = { price_list: "price-lists", brand_overview: "brand-overview", terms: "terms" };
