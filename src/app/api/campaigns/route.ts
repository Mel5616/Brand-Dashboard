...
const FIELDS = ["horizon", "campaign", "brand", "tier", "owner", "channel", "status", "key_date", "end_date", "note", "sort_order", "brief", "image_url", "pillar", "confirmed", "asana_task_gid", "asana_permalink_url", "performance_verdict", "performance_note"];
