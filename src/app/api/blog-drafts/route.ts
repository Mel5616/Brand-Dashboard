...
- Punctuation: avoid em dashes (—). Use a period for a new sentence, a comma, or a colon to introduce a list or explanation instead. Commas and full stops only — no em dashes anywhere in the output. Never start a sentence with "And".
