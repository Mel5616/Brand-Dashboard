...
export async function GET(req: Request) {
  ...
  const parts = ["select=id,token,label,recipient,created_at,open_count,first_opened_at,last_opened_at", "order=created_at.desc"];
...
export async function POST(req: Request) {
  ...
  const row = {
    ...
    label: b.label ?? null, recipient: b.recipient ?? null, html: String(b.html), created_by: access.user!.email,
  };
