...
export async function POST(req: Request) {
  ...
  const agreementRow = {
    ...
    usage_retail_partners: !!b.usage_retail_partners, usage_print: !!b.usage_print, usage_original_files: !!b.usage_original_files,
  ...
  const html = renderAgreementHtml({
    ...
    usage_retail_partners: agreementRow.usage_retail_partners, usage_print: agreementRow.usage_print, usage_original_files: agreementRow.usage_original_files,
